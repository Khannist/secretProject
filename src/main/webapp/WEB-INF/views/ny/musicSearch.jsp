...
<link href="css/ny/musicSearchcss.css" rel="stylesheet">
</head>
<body>
	
	<input type="text" class="SearchInput" id="search_Input" placeholder="검색어를 입력해주세요">
    <input type="button" class="SearchInput" id="search_Button" onclick="Search()"> 
	<img class="ToIMG" src="img/icon/ToMusicList.png" onclick="F_ToMusicList()">
	<ul>	
		<li id="search01">
			<p id="num1_th"></p>
			<p id="num1_title"></p>
